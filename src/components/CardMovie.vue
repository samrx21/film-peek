<template>
  <div class="relative w-56" @mouseover="handleHover(movie.id)" @mouseleave="handleHover(-99999)">
    <img :src="'https://image.tmdb.org/t/p/original/' + props.movie.poster_path" alt="" class="w-full h-full -z-10 relative" />
